...
<header class="main-header">
    ...
    <!-- Logo -->
    <a style="background-color: #064630;" href="{{Request::url()}}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><i class="fa fa-home"></i> </b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg active"><i class="fa fa-home"></i> Dashboard</span>
    </a>

    <!-- Header Navbar -->
    <nav style="background-color: #064630;" class="navbar navbar-static-top" role="navigation">
